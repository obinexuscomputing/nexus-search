...
class SearchEngine {
    ...
    normalizeDocument(doc) {
        ...
        return new IndexedDocument(doc.id, {
            title: ((_a = doc.fields) === null || _a === void 0 ? void 0 : _a.title) || '',
            content: ((_b = doc.fields) === null || _b === void 0 ? void 0 : _b.content) || '',
            author: ((_c = doc.fields) === null || _c === void 0 ? void 0 : _c.author) || '',
            tags: Array.isArray((_d = doc.fields) === null || _d === void 0 ? void 0 : _d.tags) ? doc.fields.tags : [],
            version: ((_e = doc.fields) === null || _e === void 0 ? void 0 : _e.version) || '1.0'
        }, {
            ...doc.metadata,
            indexed: ((_f = doc.metadata) === null || _f === void 0 ? void 0 : _f.indexed) || Date.now(),
            lastModified: ((_g = doc.metadata) === null || _g === void 0 ? void 0 : _g.lastModified) || Date.now()
        });
    }
